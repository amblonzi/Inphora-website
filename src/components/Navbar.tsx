...
export default function Navbar() {
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu Drawer */}
            <div className={`fixed inset-0 bg-slate-950/98 backdrop-blur-xl transition-all duration-300 ease-in-out md:hidden flex flex-col items-center justify-start pt-32 gap-8 z-40 ${isOpen ? "opacity-100 visible" : "opacity-0 invisible pointer-events-none"}`}>
